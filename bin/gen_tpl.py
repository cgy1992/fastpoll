...
if __name__ == '__main__':
  ...
  parser.add_argument('-p', '--prefix', metavar="prefix", type=str, nargs=1, required=False, default=[''])
  parser.add_argument('-e', '--extensions', metavar=("header", "source"), type=str, nargs=2, required=False, default=('h', 'c'), help="file extensions for output files (default: %(default)s)")
  parser.add_argument('-u', '--uppercase', metavar="def", default=("function", "constant"), nargs='+', type=str, help="set idents to uppercase format (default: %(default)s. values are: function, constant. more than one value possible")
  parser.add_argument('-m', '--max-len', metavar="max_length", default=80, nargs=1, type=int, help="maximum line length")
